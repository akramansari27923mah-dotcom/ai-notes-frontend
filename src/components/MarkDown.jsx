...
export default function ChatMarkdown({ content }) {
    ...
    return (
        <div className="w-full">
            ...
            {expanded && (
                <div className="prose prose-invert max-w-none break-words text-gray-200 bg-[#0f172a] p-5 rounded-2xl shadow-lg border border-gray-800">
                    ...
                    <ReactMarkdown
                        ...
                        components={{
                            ...
                            h3({ children }) {
                                return (
                                    <h3 className="text-xl font-medium mt-5 mb-2 text-gray-100">
                                        {children}
                                    </h3>
                                )
                            },
