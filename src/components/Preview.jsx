...
const Preview = () => {
  const { data, loader, previewDitact, setPreviewDitact, prev, setData } =
    aiContext();
  ...
  return (
    <div className="p-4 shadow-md bg-white rounded-lg md:w-5/12 w-full h-screen md:h-[615px]">
      ...
      <div className="flex justify-center items-center gap-5">
        ...
        <button
          onClick={clipBoard}
          className="flex items-center gap-2 bg-green-600 text-white px-5 py-2 text-nowrap  rounded text-sm"
        >
          {!copy ? (
            <>
              <Copy size={18} />
