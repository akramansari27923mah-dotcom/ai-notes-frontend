...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-blue-400 to-indigo-500 p-8">
      <form
        className="flex flex-col gap-4 md:w-4/12 w-full bg-white/30 backdrop-blur-xl p-6 rounded-lg"
        onSubmit={handelSign}
      >
        ...
        <div className="flex justify-center items-center">
          <button
            className="px-4 py-2 bg-indigo-500 text-white rounded-lg font-semibold focus:border-indigo-500
          "
          >
            {loader ? (
