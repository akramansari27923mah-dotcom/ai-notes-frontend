...
const Sign = () => {
  ...
  const validate = () => {
    ...
    if (!formData.username) newError.username = 'Username required'
    ...
    <div className='flex justify-center items-center h-screen bg-gradient-to-r from-blue-400 to-indigo-500 p-8'>
      <form className='flex flex-col gap-4 md:w-4/12 w-full bg-white/30 backdrop-blur-xl p-6 rounded-lg' onSubmit={handelSign}>
        ...
        <div className='flex flex-col gap-2'>
          ...
          {error.username && <p className='text-sm text-red-500 mt-1 font-semibold'>{error.username}</p>}
        </div>
        ...
        <span
          className='absolute top-[294px] left-[360px] cursor-pointer text-blue-500 font-semibold'
